          ...
          if (response.ok) {
            try {
              ...
              if (data.API_error) {
                addToHistory({
                  content:
                    "WARNING : An error occured while calling the API. Please check your flight informations, the flight may not exist.",
                  role: "system",
                  id: "2",
                });
      ...
      <AccordionContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)}>
            ...
            <Button
              type="submit"
              className="bg-secondary text-neutral rounded-md p-2 mt-8 hover:bg-blue-700 hover:text-white transition duration-300 ease-in-out w-full "
            >
              Submit
            </Button>
          </form>
